                        ...
                        <div class='iq-card'>
                            <div class='iq-card-header d-flex justify-content-between'>
                                <div class='iq-header-title'>
                                    <h4 class='card-title'>Création de votre séances</h4>
                                </div>
                            ...
                            <div class='iq-card-body'>
                                ...
                                <button type='button' class='btn btn-primary' data-toggle='modal' data-target='#modalseance_before_start'>Suivant</button>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class='modal-content'>
                                ...
                                <div class='modal-body'>
                                    <div class='form-group'>
                                        ...
                                        <input type='text' name='nomseance' class='form-control' id='nseance' placeholder='Ex: Séance Abdominaux'>
                                    </div>
